    ...
    <div className="grid-pattern flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="card space-y-5">
          ...
          <div>
            <div className="mb-2 flex items-center justify-between">
              ...
              <Link href="/auth/forgot-password" className="text-xs text-[var(--accent-secondary)] hover:underline">
                Forgot password?
              </Link>
            </div>
            <div className="relative">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button type="button" className="btn btn-secondary" onClick={() => { window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/oauth/google`; }}>
            ...
            <button type="button" className="btn btn-secondary" onClick={() => { window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/oauth/github`; }}>
        ...
        <p className="mt-6 text-center text-sm text-[var(--text-secondary)]">
          ...
          <Link href="/auth/register" className="font-medium text-[var(--accent-secondary)] hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
